...
const myModule = (() => {
  ...
  const exported = {
    ...
    publicBar: "Otro valor público",
		publicBaz: baz //aqui define publico la variable
  }

	// Exposición de variables locales
  return exported //da el permiso o expone toda la funicón para que se acceda a su información.
})()

console.log(myModule) //imprime el modulo o funvión completp